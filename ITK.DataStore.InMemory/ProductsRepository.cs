    ...
    public class ProductsRepository : IProductsRepository
    {
        ...
        public ProductsRepository()
        {
            _products = new List<Product>()
            {
                ...
                new Product { Id = 30,   CategoryId = 1008, Title = "KUHN RIKON - Herb Saver", Description = "KUHN RIKON - Herb Saver", Price = 23.95m, Image = "KUHN-RIKON-Herb-Saver.jpg", StockQuantity = 8 },
                new Product { Id = 31,   CategoryId = 1008, Title = "Cuisipro - Herb Keeper", Description = "Cuisipro - Herb Keeper", Price = 33.02m, Image = "Cuisipro-Herb-Keeper.jpg", StockQuantity = 14 },
                new Product { Id = 32,   CategoryId = 1007, Title = "KUHN RIKON 3-Piece Professional Knife Set - Multicolour", Description = "KUHN RIKON 3-Piece Professional Knife Set, Multicolour, Green, Red", Price = 23.03m, Image = "KUHN-RIKON-3-Piece-Multicolour-set.jpg", StockQuantity = 18 },
                new Product { Id = 33,   CategoryId = 1008, Title = "Simplehuman Slim Kitchen Sink Caddy", Description = "Simplehuman Slim Kitchen Sink Caddy Organiser Holder Tidy, With Suction Cups, Wire Ledge Hanger, Sponge Storage, Rustproof, Brushed Stainless Steel", Price = 15.95m, Image = "Simplehuman-Kitchen-Sink-Caddy.jpg", StockQuantity = 23},
                new Product { Id = 34,   CategoryId = 1008, Title = "Joseph Joseph Nest Chopping Board Set - Opal", Description = "Joseph Joseph Nest Chopping Board Set, Nesting Compact Boards - 3 piece, Opal", Price = 24.99m, Image = "Joseph-Joseph-Nest-Chopping-Board-Set-Opal.jpg", StockQuantity = 29},
                new Product { Id = 35,   CategoryId = 1007, Title = "OTOTO Red The Crab Silicone Spoon Rest", Description = "OTOTO Red The Crab Silicone Spoon Rest - Heat-Resistant Utensil Rest for Stove Top - BPA-Free Ladle and Spoon Holder Rest - Non-Slip Wooden Spoon Holder and Steam Releaser", Price = 17.99m, Image = "OTOTO-Red-The-Crab-Silicone-Spoon-Rest.jpg", StockQuantity = 36 }/*,
